...
$authMigrationName = "Pets_$timestamp"
$dbContextName = "PetsWriteDbContext"
$infrastructurePath = ".\src\Services\PetService\KindPaws.Pets.Infrastructure\"
$startupPath = ".\src\Services\PetService\KindPaws.Pets.Presentation\"
$migrationsPath = ".\src\Services\PetService\KindPaws.Pets.Infrastructure\Persistence\Migrations*"
