...
namespace KindPaws.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20241117203416_Accounts_20241118_013327")]
    partial class Accounts_20241118_013327
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KindPaws.Accounts.Domain.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "KindPaws.Accounts.Domain.AdminAccount.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("KindPaws.Accounts.Domain.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("KindPaws.Accounts.Domain.RolePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("KindPaws.Accounts.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("KindPaws.Accounts.Domain.AdminAccount", b =>
                {
                    b.HasOne("KindPaws.Accounts.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("KindPaws.Accounts.Domain.AdminAccount", "UserId")
            ...
            modelBuilder.Entity("KindPaws.Accounts.Domain.RolePermission", b =>
                {
                    b.HasOne("KindPaws.Accounts.Domain.Permission", "Permission")
                        .WithMany()
                    ...
                    b.HasOne("KindPaws.Accounts.Domain.Role", "Role")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("KindPaws.Accounts.Domain.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("KindPaws.Accounts.Domain.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
