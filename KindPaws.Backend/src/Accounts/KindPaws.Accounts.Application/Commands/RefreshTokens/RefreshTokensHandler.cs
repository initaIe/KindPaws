...
public class RefreshTokensHandler : ICommandHandler<RefreshTokensResponse, RefreshTokensCommand>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (refreshSessionResult.Value.IsExpired)
        ...
        if (user == null)
            return Errors.General.RecordNotFound(nameof(Account)).ToErrorList();
        ...
        var accessTokenResult = _tokenProvider.GetAccessToken(user);
