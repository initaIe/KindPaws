...
public class DeleteBreedEntitiesExistenceValidator
    : IEntitiesExistenceValidator<DeleteBreedExistenceValidationData>
{
    ...
    public DeleteBreedEntitiesExistenceValidator(
    ...
    public async Task<Result<Error>> ValidateAsync(
        DeleteBreedExistenceValidationData validationData,
        CancellationToken cancellationToken)
    {
        ...
        var isPetWithBreedIdExist = await _petExistenceValidator
            .IsPetWithBreedIdExistsAsync(validationData.BreedId, cancellationToken);
